...
STAGES = {
    ...
    "video": StageDefinition(
        ...
        VIDEOS_DIR,
        "$$ 中預算",
        "240P/MOSS 串流→Grok 4.3 minimal（失敗改 Grok 4.5 minimal）30秒三段→關鍵格安全高畫質切塊、音訊判斷 enhance＋crossfade",
        frozenset(GRID_EXTENSIONS | VIDEO_EXTENSIONS),
    ),
    ...
    "chosen": StageDefinition(
        ...
        CHOSEN_DIR,
        "$$$ 高預算",
        "240P/MOSS 串流→Grok 4.3 minimal（失敗改 Grok 4.5 minimal）30秒三段→關鍵格安全 1080P 切塊、音訊判斷 enhance＋crossfade",
        frozenset(GRID_EXTENSIONS | VIDEO_EXTENSIONS),
    ),
}
